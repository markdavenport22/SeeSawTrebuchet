function [Mass_Total, MaxAP, MaxBP] = BOptimise(OAP, OBP, d, t)
    ...
    m = 15;
    l1 = 12.11893408; % L1 Length
    l2 = 2.30191319; % L2 Length
    mcw = 1037; % Counterweight Mass
    AngVelMax = 2.4564159290852; % The max value in the operation
    P = 10.4953618684636; % Insert P from optimisation task
